...
export interface NFTStakeInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "DEFAULT_ADMIN_ROLE" | "claimRewards" | "contractType" | "contractURI" | "contractVersion" | "getRoleAdmin" | "getRoleMember" | "getRoleMemberCount" | "getStakeInfo" | "grantRole" | "hasRole" | "hasRoleWithSwitch" | "indexedTokens" | "initialize" | "isIndexed" | "isTrustedForwarder" | "multicall" | "nftCollection" | "onERC721Received" | "renounceRole" | "revokeRole" | "rewardToken" | "rewardsPerUnitTime" | "setContractURI" | "setRewardsPerUnitTime" | "setTimeUnit" | "stake" | "stakerAddress" | "stakers" | "stakersArray" | "supportsInterface" | "timeUnit" | "withdraw" | "withdrawRewardTokens"): FunctionFragment;
...
export interface NFTStake extends BaseContract {
    ...
    functions: {
        ...
        initialize(_defaultAdmin: string, _contractURI: string, _trustedForwarders: string[], _rewardToken: string, _nftCollection: string, _timeUnit: BigNumberish, _rewardsPerUnitTime: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        hasRoleWithSwitch(role: BytesLike, account: string, overrides?: CallOverrides): Promise<boolean>;
        indexedTokens(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        initialize(_defaultAdmin: string, _contractURI: string, _trustedForwarders: string[], _rewardToken: string, _nftCollection: string, _timeUnit: BigNumberish, _rewardsPerUnitTime: BigNumberish, overrides?: CallOverrides): Promise<void>;
        isIndexed(arg0: BigNumberish, overrides?: CallOverrides): Promise<boolean>;
        isTrustedForwarder(forwarder: string, overrides?: CallOverrides): Promise<boolean>;
